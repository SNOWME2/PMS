      ...
      <div class="flex flex-col gap-6 p-6">
        ...
        <div class="grid grid-cols-4 gap-3">
          <div class="bg-card border border-border rounded-xl p-4">
            ...
            <p class="text-2xl font-bold text-foreground mt-0.5">{{ properties.data.length }}</p>
          </div>
          <div class="bg-card border border-border rounded-xl p-4">
        ...
        <div class="flex items-center gap-3 flex-wrap">
          <div class="relative flex-1 min-w-50 max-w-xs">
            ...
            <Input v-model="search" placeholder="Search properties…" class="pl-8 h-9 text-[13px]"
        ...
        <!-- ── Empty state ──────────────────────────────────────────────────── -->
        <div v-if="properties.data.length === 0" class="flex flex-col items-center justify-center py-20 text-center">
          ...
          <div v-for="property in properties.data" :key="property.id"
            ...
            <div class="relative h-36 bg-muted overflow-hidden">
              ...
              <div class="absolute top-3 left-3">
                <span
                  class="text-[11px] font-medium px-2 py-0.5 rounded-full bg-background/90 text-foreground border border-border/50 backdrop-blur-sm">
            ...
            <div class="p-4">
              ...
              <div class="flex items-center justify-between mt-3 pt-3 border-t border-border">
                ...
                <div class="flex gap-1.5">
                  <span
                    class="text-[11px] px-1.5 py-0.5 rounded bg-emerald-50 text-emerald-700 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-900 font-medium">
                    {{ vacantCount(property) }} vacant
                  </span>
                  <span
                    class="text-[11px] px-1.5 py-0.5 rounded bg-blue-50 text-blue-700 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-900 font-medium">
                    {{ property.occupied_units }} occupied
                  </span>
                </div>
              </div>

              <Button variant="outline" size="sm" class="w-full mt-3 h-8 text-[12.5px]"
        ...
        <!-- ── Pagination ───────────────────────────────────────────── -->
        <div v-if="properties.last_page > 1" class="mt-8 flex justify-center">
