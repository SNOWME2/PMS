            ...
            <div class="flex flex-col gap-6 p-6 max-w-1xl">
                ...
                <div>
                    ...
                    <p class="text-[13px] text-muted-foreground mt-0.5">
                        {{
                            isEditing
                                ? "Update property details and units."
                ...
                <form @submit.prevent="submit" class="flex flex-col gap-6">
                    <!-- ── Section: Basic info ──────────────────────────────────────── -->
                    <div
                        class="bg-card border border-border rounded-xl p-5 space-y-4"
                    >
                        ...
                        <div class="space-y-1.5">
                            <Label for="name" class="text-[12.5px]"
                                >Property name
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <div class="space-y-1.5">
                                <Label for="address" class="text-[12.5px]"
                                    >Address
                            ...
                            <div class="space-y-1.5">
                                <Label for="city" class="text-[12.5px]"
                                    >City
                                    <span class="text-destructive"
                                        >*</span
                                    ></Label
                        ...
                        <!-- Description -->
                        <div class="space-y-1.5">
                            <Label for="description" class="text-[12.5px]"
                                >Description</Label
                            >
                            <Textarea
                                id="description"
                    ...
                    <!-- ── Section: Cover photo ─────────────────────────────────────── -->
                    <div
                        class="bg-card border border-border rounded-xl p-5 space-y-3"
                    >
                        <h2 class="text-[13.5px] font-semibold text-foreground">
                            Cover photo
                        </h2>
                        ...
                        <div
                            v-if="previewUrl"
                            class="relative w-full h-44 rounded-lg overflow-hidden border border-border"
                        >
                            <img
                                :src="previewUrl"
                                alt="Preview"
